...
namespace Configs {
    ...
    export class App {
        // 43.128.27.35
        public static NAME_APP = "nagaking777";
        public static IS_LOCAL = true;
        public static IS_PRO = false;
        static API: string = "https://iportal.vietkieu888.com/api";
		static API2: string = "https://iportal2.vietkieu888.com/api";
		static APIROY: string = "https://portal.vietkieu888.com/api";
        static API_PAYIN_PAYWELL_BANKS: string = "https://iportal.vietkieu888.com/api/payin/paywell/banks";
        static MONEY_TYPE = 1;
        static LINK_DOWNLOAD = "https://vietkieu888.com/download";
        static LINK_EVENT = "https://vietkieu888.com/event";
        static LINK_SUPPORT = "https://vietkieu888.com";
        static USE_WSS = false;
        static LINK_GROUP = "https://www.facebook.com/groups/vietkieu888";
        static FB_APPID = "758971848112749";
        static AGENCY_CODE = "";
        static listPrefabGame: string[] = ['BauCua','CaoThap','TaiXiuSieuToc','TaiXiuDouble','Slot3x3Gem','Slot3x3','MiniPoker'];
        static listSceneGame: string[] = ['Lobby','BaCay','BaiCao', 'Lieng', 'Loto', 'MauBinh', 'Poker', 'Sam', 'Shan', 'ShootFish', 'Slot1', 'Slot10', 'Slot11Bikini', 'Slot3', 'Slot4', 'Slot6', 'Slot7', 'Slot8', 'TienLen', 'XocDia'];
		static options = {
        ...
        static IS_SANBOX_CODA = true;
        static IS_PRODUCTION_CODA = false;
        static GameName = {
            110: "Tây Du Ký",
            170: "Dance",
            2: "Tài Xỉu",
        ...
        static readonly HOST_SOCKJS = "https://st.vietkieu888.com/";
        ...
        static getLinkFanpage() {
            switch (VersionConfig.CPName) {
                default:
                    return "https://www.facebook.com/vietkieu888";
            }
        }
