...
import NativeHelper from "../../Loading/src/NativeHelper";
...
namespace Lobby {
    ...
    export class LobbyController extends cc.Component {
        ...
        @property(cc.Label)
        lblcaothap: cc.Label = null;
        @property(cc.Label)
        lblJPTai: cc.Label = null;
        @property(cc.Label)
        lblminipoker: cc.Label = null;
        @property(cc.Label)
        lbllonuocthan: cc.Label = null;
        @property(cc.Label)
        lblXiu: cc.Label = null;
        @property(cc.Node)
        btnLoginFb: cc.Node = null;
        @property(cc.Node)
        btnCashout: cc.Node = null;
        @property(cc.Node)
        ...
        onLoad() {
            ...
            this.buttonjb.on(cc.Node.EventType.TOUCH_END, (event: cc.Event.EventTouch) => {
                ...
                let posX = this.buttonjb.x > 0 ? cc.winSize.width / 2 - 304 : -cc.winSize.width / 2 + 138;
        ...
        start() {
            ...
            BroadcastReceiver.register(BroadcastReceiver.UPDATE_NICKNAME_SUCCESS, (data) => {
                this.lblNickname.string = data["userName"];
            }, this);
            ...
            SlotNetworkClient.getInstance().addListener((data) => {
                ...
                switch (inPacket.getCmdId()) {
                    ...
                    case cmd.Code.UPDATE_JACKPOT_SLOTS: {
                        ...
                        let TAI_XIU = resJson["TAI_XIU"];
                        let aasd = (TAI_XIU["1"]["pt"] + TAI_XIU["0"]["px"]) * 10;
                        //this.lblJPTai.string = Utils.formatNumber(aasd);
                        ...
                        this.tabsListGame.updateItemJackpots("minipoker", audition["100"]["p"], minipoker["100"]["x2"] == 1, minipoker["1000"]["p"], minipoker["1000"]["x2"] == 1, minipoker["10000"]["p"], minipoker["10000"]["x2"] == 1);
                        // this.lblminipoker.string = Utils.formatNumber(minipoker["10000"]["p"]);
                        //chiemtinh
                        ...
                        this.tabsListGame.updateItemJackpots("galaxy", galaxy["100"]["p"], galaxy["100"]["x2"] == 1, galaxy["1000"]["p"], galaxy["1000"]["x2"] == 1, galaxy["10000"]["p"], galaxy["10000"]["x2"] == 1);
                        // this.lbllonuocthan.string = Utils.formatNumber(galaxy["10000"]["p"]);
                        ...
                        // this.lblcaothap.string = Utils.formatNumber(rangeRover["10000"]["p"]);
                        ...
                        for (var i = 0; i < this.listData100.length; i++) {
                            ...
                            if (this.listData100[i].gameid == "chiemtinh") {
                                this.listData100[i] = new Tophudata("chiemtinh", "Hoa Quả", chiemtinh["100"]["p"]);
                            }
                            if (this.listData100[i].gameid == "spartans") {
                                this.listData100[i] = new Tophudata("spartans", "Viking", spartan["100"]["p"]);
                            }
                            if (this.listData100[i].gameid == "audition") {
                                this.listData100[i] = new Tophudata("audition", "Tây Du Ký", audition["100"]["p"]);
                            }

                            if (this.listData100[i].gameid == "tamhung") {
                                this.listData100[i] = new Tophudata("tamhung", "Night Club", tamhung["100"]["p"]);
                            }

                            if (this.listData100[i].gameid == "zeus") {
                                this.listData100[i] = new Tophudata("zeus", "Dance", benley["100"]["p"]);
                            }
                            if (this.listData100[i].gameid == "gainhay") {
                                this.listData100[i] = new Tophudata("gainhay", "Haloween", rollroye["100"]["p"]);
                            }
                            if (this.listData100[i].gameid == "bikini") {
                                this.listData100[i] = new Tophudata("bikini", "Haloween", bikini["100"]["p"]);
                            }
                            if (this.listData100[i].gameid == "maybach") {
                                this.listData100[i] = new Tophudata("maybach", "Haloween", maybach["100"]["p"]);
                            }
                            // // 1000
                            if (this.listData1000[i].gameid == "chiemtinh") {
                                this.listData1000[i] = new Tophudata("chiemtinh", "Hoa Quả", chiemtinh["1000"]["p"]);
                            }
                            if (this.listData1000[i].gameid == "spartans") {
                                this.listData1000[i] = new Tophudata("spartans", "Viking", spartan["1000"]["p"]);
                            }
                            if (this.listData1000[i].gameid == "audition") {
                                this.listData1000[i] = new Tophudata("audition", "Tây Du Ký", audition["1000"]["p"]);
                            }

                            if (this.listData1000[i].gameid == "tamhung") {
                                this.listData1000[i] = new Tophudata("tamhung", "Night Club", tamhung["1000"]["p"]);
                            }

                            if (this.listData1000[i].gameid == "zeus") {
                                this.listData1000[i] = new Tophudata("zeus", "Dance", benley["1000"]["p"]);
                            }
                            if (this.listData1000[i].gameid == "gainhay") {
                                this.listData1000[i] = new Tophudata("gainhay", "Haloween", rollroye["1000"]["p"]);
                            }
                            if (this.listData1000[i].gameid == "bikini") {
                                this.listData1000[i] = new Tophudata("bikini", "Haloween", bikini["1000"]["p"]);
                            }
                            if (this.listData1000[i].gameid == "maybach") {
                                this.listData1000[i] = new Tophudata("maybach", "Haloween", maybach["1000"]["p"]);
                            }
                            // // 10000
                            if (this.listData10000[i].gameid == "chiemtinh") {
                                this.listData10000[i] = new Tophudata("chiemtinh", "Hoa Quả", chiemtinh["10000"]["p"]);
                            }
                            if (this.listData10000[i].gameid == "spartans") {
                                this.listData10000[i] = new Tophudata("spartans", "Viking", spartan["10000"]["p"]);
                            }
                            if (this.listData10000[i].gameid == "audition") {
                                this.listData10000[i] = new Tophudata("audition", "Tây Du Ký", audition["10000"]["p"]);
                            }

                            if (this.listData10000[i].gameid == "tamhung") {
                                this.listData10000[i] = new Tophudata("tamhung", "Night Club", tamhung["10000"]["p"]);
                            }

                            if (this.listData10000[i].gameid == "zeus") {
                                this.listData10000[i] = new Tophudata("zeus", "Dance", benley["10000"]["p"]);
                            }
                            if (this.listData10000[i].gameid == "gainhay") {
                                this.listData10000[i] = new Tophudata("gainhay", "Haloween", rollroye["10000"]["p"]);
                            }
                            if (this.listData10000[i].gameid == "bikini") {
                                this.listData10000[i] = new Tophudata("bikini", "Haloween", bikini["10000"]["p"]);
                            }
                            if (this.listData10000[i].gameid == "maybach") {
                                this.listData10000[i] = new Tophudata("maybach", "Haloween", maybach["10000"]["p"]);
                            }
                        }
        ...
        createListdata(j100: number, j1000: number, j10000: number) {
            ...
            this.listData100.push(
                new Tophudata("chiemtinh", "Hoa Quả", j100),
                new Tophudata("spartans", "Viking", j100),
                new Tophudata("audition", "Tây Du Ký", j100),
                new Tophudata("benley", "Dance", j100),
                new Tophudata("bikini", "Bikini", j100),
                new Tophudata("tamhung", "Night Club", j100),
                new Tophudata("rollRoye", "Sơn Tinh", j100),
                new Tophudata("zeus", "Dance", j100),
                new Tophudata("maybach", "Haloween", j100),
                // new Tophudata("shootfish", "Bắn Cá", j100)
            );
            this.listData1000.push(
                new Tophudata("chiemtinh", "Hoa Quả", j1000),
                new Tophudata("spartans", "Viking", j1000),
                new Tophudata("audition", "Tây Du Ký", j1000),
                new Tophudata("benley", "Dance", j1000),
                new Tophudata("bikini", "Bikini", j1000),
                new Tophudata("tamhung", "Night Club", j1000),
                new Tophudata("rollRoye", "Sơn Tinh", j1000),
                new Tophudata("zeus", "Dance", j1000),
                new Tophudata("maybach", "Haloween", j1000),
                // new Tophudata("shootfish", "Bắn Cá", j1000)
            );
            this.listData10000.push(
                new Tophudata("chiemtinh", "Hoa Quả", j10000),
                new Tophudata("spartans", "Viking", j10000),
                new Tophudata("audition", "Tây Du Ký", j10000),
                new Tophudata("benley", "Dance", j10000),
                new Tophudata("bikini", "Bikini", j10000),
                new Tophudata("tamhung", "Night Club", j10000),
                new Tophudata("rollRoye", "Sơn Tinh", j10000),
                new Tophudata("zeus", "Dance", j10000),
                new Tophudata("maybach", "Haloween", j10000),
            ...
            Http.get(Configs.App.API, { c: 17, u: data.u, at: data.at }, (err, res) => {
                ...
                switch (parseInt(res["errorCode"])) {
                    case 0:
                        ...
                        let dataLogin: any = {};
                        if (Configs.Login.Nickname.substring(0, 5).toLowerCase() == "guest") {
                            Configs.Login.Username = Configs.Login.Nickname;
                            Configs.Login.Password = userInfo["username"];
                        } else {
        ...
        actLogin(uname = null, pass = null, callback = null): void {
            ...
            App.instance.showLoading(true);
            Http.get(Configs.App.API, { c: 3, un: username, pw: password, area: Configs.App.NAME_APP}, (err, res) => {
                switch (parseInt(res["errorCode"])) {
                    case 0:
                        App.instance.showLoading(false);
        ...
        actPlaynow(): void {
            this.deviceID = cc.sys.localStorage.getItem("vietkieu888-deviceid")
            console.log("PLAY NOW, DEVICEID ", this.deviceID);
            Http.get(Configs.App.API, { c: 12, devi: this.deviceID, area: Configs.App.NAME_APP}, (err, res) => {

                switch (parseInt(res["errorCode"])) {
                    case 0:
                        App.instance.showLoading(false);
                        SPUtils.setUserName(res["username"]);
                        SPUtils.setUserPass(res["password"]);
                        Configs.Login.Username = res["username"];
                        Configs.Login.Password = res["password"];
                        LogEvent.getInstance().sendEventClickShop("vin", 100000);
                        LogEvent.getInstance().sendEventSdt("0123456789");
                        LogEvent.getInstance().sendEventPurchase("vin", 100000);
                        LogEvent.getInstance().sendEventSigupSuccess("normal");
        ...
        fbRespone(response) {
            if (response.status != "200") {
                if (response.response != "wait") {
                    ...
                    App.instance.showLoading(false);
                    App.instance.showErrLoading("ស្ថានភាពមានបញ្ហាក្នុងការចូល: " + response.status);
        ...
        actShareFbLink(link) {
            ...
            FB.ui({
                ...
                method: 'share',
                href: link,
                caption: 'ក្លាយជាអ្នកមានជាមួយ vietkieu888'
            }, function (response) {
        ...
        actDangPhatTrien() {
            ...
            App.instance.alertDialog.showMsg("ជំនាញកំពុងប្រសើរឡើង!");
        ...
        actOpenFB() {
            cc.sys.openURL("https://www.facebook.com/joker123en");
        ...
        actOpenLive() {
            ...
            //App.instance.openWebView("https://vietkieu888.com");
        }

        actOpenZalo() {
            cc.sys.openURL("https://t.me/joker123EN");
        }
        ...
        actOpenHotLine() {
            if (cc.sys.isNative) {
                ...
                App.instance.alertDialog.showMsg("Hotline : ");
            }
        }
        ...
        actSupportOnline() {
            ...
            if (!cc.sys.isNative) {
                var url = "https://t.me/joker_123_bot";
                cc.sys.openURL(url);
                //Tawk_API.toggle();
            }
            else {
        ...
        actGoToShootFish() {
            ...
            // if (Configs.Login.Nickname.substring(0,5).toLowerCase() == "guest") {
            //     App.instance.alertDialog.showMsg(App.instance.getTextLang('txt_check_guest'));
            //     return;
            // }
        ...
        actGoToShan() {
            ...
            App.instance.removeAllWebView();
            App.instance.isShowNotifyJackpot = false;
            App.instance.openGame("Shan", "Shan");
        }
        actKiemTien() {
            if (!Configs.Login.IsLogin) {
                App.instance.alertDialog.showMsg(App.instance.getTextLang('txt_need_login'));
        ...
        checkAppVersion() {
            if (typeof Configs.App.VERSION_APP != "undefined") {
                ...
                if (versionApp < versionConfig) {
                    let url = "https://vietkieu888.com/"
                    if (cc.sys.os == cc.sys.OS_ANDROID || cc.sys.os == cc.sys.OS_IOS) {
                        App.instance.showConfirmDialog("កំណែថ្មីអាចរកបាន.\nសូមអាប់ដេតកម្មវិធីដើម្បីទទួលបានបទពិសោធន៍ល្អបំផុត!", () => {
                            cc.sys.openURL(url);
                        }, false)
                    }
        ...
        getListPaymentChannel() {
            Http.get(Configs.App.API, { "c": 2050}, (err, res) => {
                App.instance.showLoading(false);
                Global.ListPaymentChannel = res;
            });
        }
        turnOffCashout(){
            let statusBtnCashout = this.btnCashout.getComponent(cc.Button);
            let statusBtnHistory = this.btnHistory.getComponent(cc.Button);
            Http.get(Configs.App.API, { c: "7777" , nn: Configs.Login.Nickname}, (err, res) => {
                if (res.hasOwnProperty("toggle")) {
                    statusBtnCashout.interactable = res.toggle;
                    statusBtnHistory.interactable = res.toggle;
                }
            })
        }
        refreshCoin(){
            Http.get(Configs.App.API, { c: "7778" , nn: Configs.Login.Nickname}, (err, res) => {
